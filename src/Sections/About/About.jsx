            ...
            <div className="text-container">
              <div className="about-content">
                <div className="about-single-column">
                  <div className="about-me-section animate-item">
                  ...
                  <div className="education-section animate-item">
                  ...
                  <div className="current-role-section animate-item">
                  ...
                  <div className="experience-section animate-item">
